...
import { Paragraph, Dialog, HelperText } from "react-native-paper";
      ...
      <View style={styles.view}>
        ...
        <View style={styles.viewAddCar}>
          <View>
            ...
            />
            <HelperText style={{ marginVertical: 3 }} type="error">
              {this.state.error}
            </HelperText>
          </View>
          <Button
            mode="contained"
            disabled={!this.state.carNumber ? true : false}
            color="#000000"
            onPress={() => {
              this.onPressAddCar();
            }}
        ...
        <Text style={styles.text1}>
          No Of Parking Space {this.state.arrLot.length}.
        </Text>
        <View style={styles.separator} />
        <Dialog
